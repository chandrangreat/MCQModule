...
var McqPlayerComponent = /** @class */ (function () {
    ...
    ], McqPlayerComponent.prototype, "onQuestionPublished", void 0);
    __decorate([
        core.Output(),
        __metadata("design:type", Object)
    ], McqPlayerComponent.prototype, "onQuestionDrafted", void 0);
    McqPlayerComponent = __decorate([
        core.Component({
            selector: 'app-mcq-player',
            template: "\n<md-card>\n  <h3>Create MCQ question</h3>\n\n  <md-form-field class=\"full-width-input\">\n    <textarea mdInput [(ngModel)]=\"mcq.problemStatement.value\" placeholder=\"Question\" mdTextareaAutosize></textarea>\n  </md-form-field>\n\n  <md-form-field class=\"full-width-input\">\n    <textarea [(ngModel)]=\"instructions\" mdInput placeholder=\"Instructions (optional)\" mdTextareaAutosize></textarea>\n  </md-form-field>\n\n  <h4>Options</h4>\n  <md-radio-group>\n    <div *ngFor=\"let option of mcq.options\">\n      <md-radio-button value=\"{{option.id}}\" (change)=\"onAnswerSelection(option)\"></md-radio-button>\n      <md-form-field>\n        <input mdInput placeholder=\"Option\" [(ngModel)]=\"option.value\">\n      </md-form-field>\n      <button md-button (click)=\"removeOption()\" color=\"primary\">Remove Option</button>\n    </div>\n  </md-radio-group>\n\n  <div>\n    <md-radio-button disabled></md-radio-button>\n    <button md-button (click)=\"addOption()\" color=\"primary\">Add Option</button>\n  </div>\n\n  <md-card-actions class=\"mcq-card-action-section\">\n    <button md-button (click)=\"saveAsDraft()\" color=\"primary\">Save as Draft</button>\n    <button md-button (click)=\"publishQuestion()\" color=\"primary\">Publish</button>\n  </md-card-actions>\n</md-card>\n",
            styles: [".mcq-card-action-section {\n  text-align: right; }\n"]
        }),
...
var AnimationAstBuilderVisitor = (function () {
    ...
    AnimationAstBuilderVisitor.prototype.visitAnimate = function (metadata, context) {
        ...
        var /** @type {?} */ styles;
        var /** @type {?} */ styleMetadata = metadata.styles ? metadata.styles : animations.style({});
...
var TransitionAnimationEngine = (function () {
    ...
    TransitionAnimationEngine.prototype._flushAnimations = function (cleanupFns, microtaskId) {
        ...
        var _a = cloakAndComputeStyles(this.driver, leaveNodesWithoutAnimations, allPostStyleElements, animations.AUTO_STYLE), postStylesMap = _a[0], allLeaveQueriedNodes = _a[1];
        ...
        var preStylesMap = (allPreStyleElements.size ?
            cloakAndComputeStyles(this.driver, enterNodesWithoutAnimations, allPreStyleElements, animations.ɵPRE_STYLE) :
            [new Map()])[0];
...
var BrowserAnimationBuilder = (function (_super) {
    ...
    BrowserAnimationBuilder.prototype.build = function (animation) {
        ...
        var /** @type {?} */ entry = Array.isArray(animation) ? animations.sequence(animation) : animation;
